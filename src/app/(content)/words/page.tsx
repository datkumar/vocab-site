...
export default async function WordsPage() {
  ...
  return (
    <div className="container max-w-6xl w-full h-full mx-auto py-6 md:py-8 px-4 md:px-6">
      <h1 className="text-3xl md:text-4xl font-serif font-extrabold text-center text-rose-800 pb-6">
        Glossary
      </h1>
        ...
        {Object.entries(groupedWords).map(
          ([letter, letterWords]) =>
            letterWords.length > 0 && (
              <div
                key={letter}
                className="bg-amber-50 rounded-2xl p-6 border border-amber-900 shadow-sm"
              >
